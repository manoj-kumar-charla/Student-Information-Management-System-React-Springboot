...
public class StudentServiceImplementation implements StudentService {
    ...
    public StudentDto createStudent(StudentDto studentDto) {
        ...
        List<Course> courses = courseRepository.findAllById(studentDto.getCourseCodes());
